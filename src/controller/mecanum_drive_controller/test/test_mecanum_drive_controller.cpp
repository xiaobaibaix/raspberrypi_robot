...
namespace
{
const std::vector<std::string> wheel_names = {"front_left_wheel", "front_right_wheel", "rear_left_wheel", "rear_right_wheel"};
}  // namespace
...
protected:
  ...
  controller_interface::return_type InitController(
    const std::vector<std::string> wheel_joints_init = wheel_names,
    const std::vector<rclcpp::Parameter> & parameters = {}, const std::string ns = "")
  {
    ...
    // default parameters
    parameter_overrides.push_back(
      rclcpp::Parameter("wheel_separation_x", rclcpp::ParameterValue(1.0)));
      parameter_overrides.push_back(
      rclcpp::Parameter("wheel_separation_y", rclcpp::ParameterValue(1.0)));
  ...
  hardware_interface::StateInterface front_left_wheel_pos_state_{
    wheel_names[0], HW_IF_POSITION, &position_values_[0]};
  hardware_interface::StateInterface front_right_wheel_pos_state_{
    wheel_names[1], HW_IF_POSITION, &position_values_[1]};
  hardware_interface::StateInterface rear_left_wheel_pos_state_{
    wheel_names[2], HW_IF_POSITION, &position_values_[0]};
  hardware_interface::StateInterface rear_right_wheel_pos_state_{
    wheel_names[3], HW_IF_POSITION, &position_values_[1]};
  hardware_interface::StateInterface front_left_wheel_vel_state_{
    wheel_names[0], HW_IF_VELOCITY, &velocity_values_[0]};
  hardware_interface::StateInterface front_right_wheel_vel_state_{
    wheel_names[1], HW_IF_VELOCITY, &velocity_values_[1]};
  hardware_interface::StateInterface rear_left_wheel_vel_state_{
    wheel_names[2], HW_IF_VELOCITY, &velocity_values_[0]};
  hardware_interface::StateInterface rear_right_wheel_vel_state_{
    wheel_names[3], HW_IF_VELOCITY, &velocity_values_[1]};
  ...
  hardware_interface::CommandInterface front_right_wheel_vel_cmd_{
    wheel_names[1], HW_IF_VELOCITY, &velocity_values_[1]};
  hardware_interface::CommandInterface rear_left_wheel_vel_cmd_{
    wheel_names[2], HW_IF_VELOCITY, &velocity_values_[0]};
  hardware_interface::CommandInterface rear_right_wheel_vel_cmd_{
    wheel_names[3], HW_IF_VELOCITY, &velocity_values_[1]};
...
TEST_F(TestMecanumDriveController, init_fails_without_parameters)
{
  const auto ret =
...
TEST_F(TestMecanumDriveController, configure_succeeds_when_wheels_are_specified)
{
  ...
  ASSERT_THAT(state_if_conf.names, SizeIs(4));
  EXPECT_EQ(state_if_conf.type, controller_interface::interface_configuration_type::INDIVIDUAL);
  auto cmd_if_conf = controller_->command_interface_configuration();
  ASSERT_THAT(cmd_if_conf.names, SizeIs(4));
  EXPECT_EQ(cmd_if_conf.type, controller_interface::interface_configuration_type::INDIVIDUAL);
}

TEST_F(TestMecanumDriveController, configure_succeeds_tf_test_prefix_false_no_namespace)
{
...
TEST_F(TestMecanumDriveController, configure_succeeds_tf_test_prefix_true_no_namespace)
{
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
  std::string frame_prefix = "test_prefix";
...
TEST_F(TestMecanumDriveController, configure_succeeds_tf_blank_prefix_true_no_namespace)
{
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
...
TEST_F(TestMecanumDriveController, configure_succeeds_tf_test_prefix_false_set_namespace)
{
...
TEST_F(TestMecanumDriveController, configure_succeeds_tf_test_prefix_true_set_namespace)
{
  std::string test_namespace = "/test_namespace";
...
TEST_F(TestMecanumDriveController, configure_succeeds_tf_blank_prefix_true_set_namespace)
{
  std::string test_namespace = "/test_namespace";
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
...
TEST_F(TestMecanumDriveController, test_speed_limiter)
{
  ASSERT_EQ(
    InitController(
      wheel_names,
  ...
  for (int i = 0; i < 3; ++i)
  {
    ASSERT_EQ(
      ...
      controller_interface::return_type::OK);
    EXPECT_NEAR(0.0, front_left_wheel_vel_cmd_.get_value(), 1e-3);
    EXPECT_NEAR(0.0, front_right_wheel_vel_cmd_.get_value(), 1e-3);
    EXPECT_NEAR(0.0, rear_left_wheel_vel_cmd_.get_value(), 1e-3);
    EXPECT_NEAR(0.0, rear_right_wheel_vel_cmd_.get_value(), 1e-3);
  }
