...
def generate_launch_description():
    ...
    packagepath = get_package_share_directory("robot_car_control")
    robot_description = Command([
        'xacro ',
        PathJoinSubstitution([FindPackageShare('robot_car_control'), 'urdf', urdfname]),
        ' ',
